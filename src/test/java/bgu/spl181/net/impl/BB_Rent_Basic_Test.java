...
public class BB_Rent_Basic_Test extends ReactorServerClientTestTemplate {
	@Test(timeout = 50000)
	public void BB_Rent_Basic_Test() throws IOException {
		String testPath = "./src/test/resources/Basic_Rent_Test/";
